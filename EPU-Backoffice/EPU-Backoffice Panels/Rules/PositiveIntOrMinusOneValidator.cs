// -----------------------------------------------------------------------
// <copyright file="PositiveIntOrMinusOneValidator.cs" company="Marvin&Felix">
...
namespace EPU_Backoffice_Panels.Rules
{
    ...
    /// </summary>
    public class PositiveIntOrMinusOneValidator : IRule
    {
        /// <summary>
        ...
        public void Eval(object input)
        {
            ...
            this.HasErrors = outval >= 0 || outval == -1 ? false : true;
        }
    }
}
