...
namespace EPU_Backoffice_Panels.Dal
{
    ...
    public class DataBaseManager : IDAL
    {
        ...
        public void CreateDataBase()
        {
            ...
            sb.Append("CREATE TABLE IF NOT EXISTS Ausgangsrechnung (ID INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, KundenID INTEGER NOT NULL, Rechnungsdatum TIMESTAMP NOT NULL, Bezeichnung VARCHAR(150) NOT NULL); ");
