...
namespace EPUBackoffice.Dal
{
    ...
    public class DataBaseManager : IDAL
    {
        ...
        public void CreateDataBase()
        {
            ...
            sb.Append("CREATE TABLE IF NOT EXISTS Rechnungszeile (ID INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, ProjektID INTEGER NOT NULL, AusgangsrechnungsID INTEGER NOT NULL,BEzeichnung Varchar(150), Stunden INTEGER NOT NULL); ");
