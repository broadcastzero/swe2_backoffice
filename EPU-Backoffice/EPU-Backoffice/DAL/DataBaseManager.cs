...
namespace EPUBackoffice.Dal
{
    ...
    public class DataBaseManager : IDAL
    {
        ...
        public void CreateDataBase()
        {
            ...
            sb.Append("CREATE TABLE IF NOT EXISTS Projekt (ID INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, AngebotID INTEGER NOT NULL, Projektname VARCHAR(100) NOT NULL, Projektstart TIMESTAMP); ");
